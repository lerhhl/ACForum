...
#Topics
topic_1 = Topic.create(title: 'Are cats beautiful?', body: 'Cats stuffs', user_id: user_1.id, votes: 5, status: 1, tag_id: 1)
topic_2 = Topic.create(title: 'Are dogs beautiful?', body: 'Dogs stuffs', user_id: user_1.id, votes: 3, status: 2, tag_id: 1)
